========================================================================
    KONSOLENANWENDUNG: Bwinf_Landnahme-Projektübersicht
========================================================================

Diese Bwinf_Landnahme-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Bwinf_Landnahme-Anwendung besteht.


Bwinf_Landnahme.vcxproj
...
Bwinf_Landnahme.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Bwinf_Landnahme.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
